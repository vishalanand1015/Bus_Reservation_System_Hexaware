...
class BusOperatorsServiceTest {
	  ...
	  @Mock
		...
		void testCreateBusOperators() {
			...
			busOperators.setRating(busOperatorsDTO.getRating());
...
//			verify(passwordEncoderMock)bookings.encode(bookingsDTO.getPassword());
			...
			assertEquals(busOperators.getRating(), createdBusOperators.getRating());
	  	}
		...
		void testDeleteBusOperators() {
			...
			existingBusOperators.setRating(existingBusOperators.getRating());
		...
		void testGetBusOperatorsById () {
			...
			assertEquals(existingBusOperators.getRating(), busOperatorsDTO.getRating());
