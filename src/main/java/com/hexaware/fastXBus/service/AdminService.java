...
public class AdminService implements IAdminService {
	...
	public Admin createAdmin(AdminDTO admindto) {
		...
		admin.setGetRole(admindto.getGetRole());
	...
	public Admin updateAdmin(AdminDTO admindto, Long adminId) {
	    ...
	    if (adminOptional.isPresent()) {
	        ...
	        existingAdmin.setGetRole(admindto.getGetRole());
	...
	public AdminDTO getAdmin(Long adminId) {
		...
		return new AdminDTO(admin.getAdminId(),admin.getFirstName(),admin.getLastName(),admin.getEmail(),admin.getPassword(),admin.getPhoneNumber(),admin.getGetRole());
	}
