...
public class UserCustomersService implements IUserCustomersService {
	...
	public UserCustomers createUser(UserCustomersDTO usercustomerdto) {
		...
		usercustomer.setRole(usercustomerdto.getRole());
	...
	public UserCustomers updateUser(UserCustomersDTO usercustomerdto, Long userId) {
	    ...
	    if (userOptional.isPresent()) {
	        ...
	        existingUser.setRole(usercustomerdto.getRole());
	...
	public UserCustomersDTO getUserById(Long userId) {
		...
		return new UserCustomersDTO(usercustomers.getUserId(),usercustomers.getFirstName(),usercustomers.getLastName(),usercustomers.getEmail(),usercustomers.getPassword(),usercustomers.getPhoneNumber(),usercustomers.getAddress(),usercustomers.getCity(),usercustomers.getState(),usercustomers.getZipCode(),usercustomers.getRole());
	}
